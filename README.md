...
Tables need primary keys to identify each entry in the database uniquely.
...
We need another table that connects to the other two or more tables using foreign keys. 
